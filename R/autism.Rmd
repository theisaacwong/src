...
write.table(df00, "C:/docs/autism/coverage/hg38_coverage_ggplot2.tsv", sep="\t", col.names = TRUE, row.names = FALSE, quote=FALSE)
...
write.table(df_print, "C:/docs/autism/coverage/hg38_coverage_main2.tsv", sep="\t", col.names = TRUE, row.names = FALSE, quote=FALSE)
...
ggsave("C:/docs/autism/coverage/coverage_hg38_window2.pdf", g2, width = 15, height = 7, units = "in")
```
...
write.table(df00, "C:/docs/autism/coverage/T2T_coverage_ggplot2.tsv", sep="\t", col.names = TRUE, row.names = FALSE, quote=FALSE)
sampleToChr <- HashMap$new()
temp1 <- lapply(seq_down(df00), function(x){
  curr_sample <- df00$sample[x]
  if(sampleToChr$containsKey(curr_sample)==FALSE){sampleToChr$put(curr_sample, HashMap$new())}
...
write.table(df_print, "C:/docs/autism/coverage/T2T_coverage_main2.tsv", sep="\t", col.names = TRUE, row.names = FALSE, quote=FALSE)
...
g2 <- ggplot(df02) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) ; g2
ggsave("C:/docs/autism/coverage/coverage_T2T_window2.pdf", g2, width = 15, height = 7, units = "in")
```
