...
```{bash}
find -type f | grep flac$ | sed "s/'/\\\\'/g" | sed "s/.flac$//g" | xargs -I {} /bin/bash -c 'ls -lh "{}.flac"; ffmpeg -i "{}.flac"  -ab 320k -map_metadata 0 -id3v2_version 3  -write_id3v1  1  "{}.mp3"; ls -lh "{}.mp3"  '
```

delete flacs
```{bash}
find -type f | grep flac$ | sed "s/'/\\\\'/g" | xargs -I {} /bin/bash -c 'rm -rf "{}"'
```
