...
protype1 <- pro[which(as.numeric(as.character(pro$probandAB)) > 0.3 & as.numeric(as.character(pro$fatherDP)) > 5 & as.numeric(as.character(pro$motherDP)) > 5 & as.numeric(as.character(pro$probandGQ)) > 20 & as.numeric(as.character(pro$probandDP)) > 5),]
