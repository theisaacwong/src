...
import "https://raw.githubusercontent.com/broadinstitute/hidive/refs/heads/kvg_locityper_modes/wdl/ValidateVariants.wdl" as local_locityper
...
workflow local_scatter {
    ...
    scatter (scatter_index in range(length(crams))) {
        call local_locityper.ValidateVariants as locityper_inst {
            input:
    ...
    output {
        Array[File] results_tar_gzs = locityper_inst.results_tar_gz
        Array[File] summary_csvs = locityper_inst.summary_csv
    }
